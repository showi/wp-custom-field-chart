...
class Field {
	...
	function __construct($name, $required, $default=Null, $match=Null, $info=Null) {
		$this->name = $name;
	...
	function make_error_message() {
		$out = '<div class="cfc-error" style="background-color: black; color:white; padding: 0.5em 1em; font-family: Arial; border-style: solid; border-width:2px; border-color: red">';
